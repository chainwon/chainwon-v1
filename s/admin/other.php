...
<tr>
    ...
    <td valign="top">
<textarea name="diykey" cols="30" rows="8" style="width:350px; height:160px; float:left; display:inline-block;"><?php $diykey = file_get_contents('../data/huoduan.diykey.txt');echo $diykey;?></textarea> <div style="display:inline-block; width:440px; float:left; margin:20px 0 0 10px;"><span class="gray">★默认设置下首页和搜索页的“网友在搜”其实是一个自定义关键词功能，这里可以填写自定义的关键词，将在首页和搜索页面右侧随机显示，
一行一个关键词。<br />
