...
<link rel="canonical" href="http://<?php echo PCDOMAIN.SYSPATH?>" />
...
<div class="searchbox">
 <form action="./" method="get"><input align="middle" name="q" class="q" id="kw" value="请输入关键字搜索" onfocus="javascript:if(this.value=='请输入关键字搜索'){this.value='';this.style.color='#333'}" onblur="javascript:if(this.value==''){this.value='请输入关键字搜索';this.style.color='#CCC'}" maxlength="1000" size="50" autocomplete="off" baiduSug="1" x-webkit-speech /><input name="re" type="hidden" value="1" /><input id="btn" class="btn" align="middle" value="搜索" type="submit" />
        </form>
</div>
<?php
...
?>
<div id="footer"><p><a href="http://<?php echo PCDOMAIN?><?php echo SYSPATH?>">电脑版</a></p><?php echo $huoduan['foot']?></div>
